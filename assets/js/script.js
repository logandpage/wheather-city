...
async function displayWeather() {
    ...
    var queryURL = "https://api.openweathermap.org/data/2.5/weather?q=" + cityname + "&appid=3b2c4bb077aad92d3b12fb80336b91e5"
    ...
    var response = await $.ajax({
        ...
        var uvURL = "http://api.openweathermap.org/data/2.5/uvi?appid=3b2c4bb077aad92d3b12fb80336b91e5&lat="+getLat+"&lon="+getLong;
...
async function displayFiveDayForecast() {
    ...
    var queryURL = "https://api.openweathermap.org/data/2.5/forecast?q="+cityname+"&appid=3b2c4bb077aad92d3b12fb80336b91e5"; 
